...
const Guidelines = () => {
  ...
  const rules = [
    ...
    },
    {
      ...
      description: 'Difficulty adapts based on your performance. Correct answers increase difficulty by 1, wrong answers decrease it by 1. Difficulty ranges from 1 to 5.',
      color: 'text-yellow-400',
    },
    {
      icon: IoFlash,
      title: 'Scoring System',
      description: 'Points awarded based on difficulty: Level 1 = 1 point, Level 2-3 = 4 points, Level 4-5 = 10 points. No points deducted for wrong answers.',
      color: 'text-yellow-400',
    },
    {
      icon: IoTrophy,
  ...
  const tips = [
    ...
    'Master easier questions to unlock higher difficulty levels',
  ];
    ...
    <div className="min-h-screen p-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="flex items-center mb-12">
          ...
          >
            <IoArrowBack className="text-2xl mr-2 group-hover:translate-x-[-4px] transition-transform duration-300" />
        ...
        <div className="space-y-12">
          ...
          <div className="bg-gradient-to-r from-yellow-400/10 via-yellow-500/10 to-yellow-600/10 backdrop-blur-xl 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-8">
              <div className="bg-black/40 rounded-2xl p-6 border border-blue-400/30">
                <div className="text-4xl font-bold text-blue-400 mb-3">+1</div>
                <div className="text-white font-bold text-lg mb-2 tracking-wide">DIFFICULTY 1</div>
                <div className="text-gray-400 text-sm tracking-wide">Beginner Level</div>
              </div>
              <div className="bg-black/40 rounded-2xl p-6 border border-green-400/30">
                <div className="text-4xl font-bold text-green-400 mb-3">+4</div>
                <div className="text-white font-bold text-lg mb-2 tracking-wide">DIFFICULTY 2-3</div>
                <div className="text-gray-400 text-sm tracking-wide">Intermediate Level</div>
              </div>
              <div className="bg-black/40 rounded-2xl p-6 border border-purple-400/30">
                <div className="text-4xl font-bold text-purple-400 mb-3">+10</div>
                <div className="text-white font-bold text-lg mb-2 tracking-wide">DIFFICULTY 4-5</div>
                <div className="text-gray-400 text-sm tracking-wide">Expert Level</div>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center">
              <div className="bg-black/40 rounded-2xl p-6 border border-orange-400/30">
                ...
                <div className="text-gray-400 text-sm tracking-wide">No penalty • Difficulty -1</div>
              </div>
